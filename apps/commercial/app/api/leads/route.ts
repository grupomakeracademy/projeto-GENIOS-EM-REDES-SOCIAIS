...
export async function POST(request: Request) {
  try {
    ...
    const { requestId, company, email, whatsapp, sector, employees, marketing, team, difficulty, consent } = parsed.data;
    const payload = { company, email, whatsapp, sector, employees, marketing, team, difficulty, consent };
